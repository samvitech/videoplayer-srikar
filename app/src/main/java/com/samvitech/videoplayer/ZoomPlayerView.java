...
public final class ZoomPlayerView extends FrameLayout {
    ...
    public ZoomPlayerView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ZoomPlayerView(Context context, AttributeSet attrs, int defStyleAttr) {
